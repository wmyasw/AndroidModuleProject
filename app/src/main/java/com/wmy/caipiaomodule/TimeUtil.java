...
public class TimeUtil {
	...
	public static TimeUtil getInstance(String year, String month) {
		TimeUtil th = new TimeUtil();
	...
	public static TimeUtil getInstance(String year, String month, String day) {
		TimeUtil th = new TimeUtil();
	 ...
	 * @return
	 */
	public static TimeUtil getInstance(int year, int month, int day) {
		TimeUtil th = new TimeUtil();
	 ...
	 */
	public static TimeUtil getInstance(String date_time) {
	...
	public static TimeUtil getInstance(long timeInMillis) {
		TimeUtil th = new TimeUtil();
		th.set(timeInMillis);
		return th;
	}
	...
	public String getYYYYMMDDPrevious() {
		TimeUtil previousDay = getTimeHandlerPrevious();
	...
	public String getYYYYMMDDNext() {
		TimeUtil nextDay = getTimeHandlerNext();
	 ...
	 * @return
	 */
	public TimeUtil getTimeHandlerPrevious() {
		long todayTimeInMillis = this.getTimeInMillis();
		TimeUtil previousDay = TimeUtil.getInstance(todayTimeInMillis - 24 * 3600 * 1000l);
		return previousDay;
	}
	 ...
	 * @return
	 */
	public TimeUtil getTimeHandlerNext() {
		long todayTimeInMillis = this.getTimeInMillis();
		TimeUtil nextDay = TimeUtil.getInstance(todayTimeInMillis + 24 * 3600 * 1000l);
		return nextDay;
	}
	...
	public static String now() {
		return TimeUtil.getInstance().getTimestamp().toString().substring(0, 19);
	}
	...
	public static TimeUtil linuxTimeToWinTime(TimeUtil timeHandler) {
