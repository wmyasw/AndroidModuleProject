...
import com.wmy.module_main.media.AndroidMediaController;
import com.wmy.module_main.media.IRenderView;
import com.wmy.module_main.media.IjkVideoView;
import com.wmy.module_main.media.InfoHudViewHolder;
import com.wmy.module_main.media.LeoMediaController;
import com.wmy.module_main.media.SurfaceRenderView;
import com.wmy.module_main.media.TextureRenderView;
...
public class IjkPlayerManager {
    ...
    LeoMediaController mediaController;
    ...
    private OnInfoListener onInfoListener = new OnInfoListener() {
        @Override
        public void onInfo(IMediaPlayer mediaPlayer,int what, int extra) {
    ...
    public IjkPlayerManager(final Activity activity) {
        try {
        ...
        mediaController=new LeoMediaController(activity);
        videoView.setMediaController(mediaController);
        videoView.setHudView(new TableLayout(activity));
        videoView.setOnCompletionListener(new IMediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(IMediaPlayer mp) {
                statusChange(STATUS_COMPLETED);
                onCompleteListener.onComplete(mp);
            }
        });
...
//                      Toast.show("download rate:" + extra);
    ...
    private void statusChange(int newStatus) {
        ...
        if (!isLive && newStatus == STATUS_COMPLETED) {
            DebugLog.d("player", "statusChange STATUS_COMPLETED...");
            if (playerStateListener != null) {
                playerStateListener.onComplete();
            }
        } else if (newStatus == STATUS_ERROR) {
            DebugLog.d("player", "statusChange STATUS_ERROR...");
            if (playerStateListener != null) {
...
//            $.id(R.id.app_video_loading).visible();
            ...
            DebugLog.d("player", "statusChange STATUS_LOADING...");
        } else if (newStatus == STATUS_PLAYING) {
            DebugLog.d("player", "statusChange STATUS_PLAYING...");
            if (playerStateListener != null) {
    ...
    public void release(boolean cleartargetstate){
        videoView.release(cleartargetstate);
    }
    ...
    private void onVolumeSlide(float percent) {
        ...
        DebugLog.d("player", "onVolumeSlide:" + s);
    }
    ...
    private void onProgressSlide(float percent) {
        ...
        if (showDelta != 0) {
            ...
            DebugLog.d("player", "onProgressSlide:" + text);
        }
    }
    ...
    private void onBrightnessSlide(float percent) {
        ...
        DebugLog.d("player", "brightness:" + brightness + ",percent:" + percent);
    ...
    @param
    scaleType */
    TextureRenderView surfaceRenderView = null;

    public void setScaleType(String scaleType) {
        if (surfaceRenderView == null)
            surfaceRenderView = new TextureRenderView(activity);
        if (SCALETYPE_FITPARENT.equals(scaleType)) {
            ...
            surfaceRenderView.setAspectRatio(IRenderView.AR_ASPECT_FILL_PARENT);
        } else if (SCALETYPE_WRAPCONTENT.equals(scaleType)) {
            surfaceRenderView.setAspectRatio(IRenderView.AR_ASPECT_WRAP_CONTENT);
        } else if (SCALETYPE_FITXY.equals(scaleType)) {
            surfaceRenderView.setAspectRatio(IRenderView.AR_MATCH_PARENT);
        } else if (SCALETYPE_16_9.equals(scaleType)) {
            surfaceRenderView.setAspectRatio(IRenderView.AR_16_9_FIT_PARENT);
        } else if (SCALETYPE_4_3.equals(scaleType)) {
            surfaceRenderView.setAspectRatio(IRenderView.AR_4_3_FIT_PARENT);
        }
        videoView.setRenderView(surfaceRenderView);
    }
    ...
    /**
     * is player support this device * @return
     */
    ...
    /**
     * get video duration * @return
     */
    public int getDuration() {
        return videoView.getDuration();
    }

    public IjkPlayerManager playInFullScreen(boolean fullScreen) {
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        return this;
    ...
    public IjkPlayerManager onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener) {
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }

    /**
     * set is live (can't seek forward) * @param isLive * @return
     */
    public IjkPlayerManager live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }
    ...
    public interface OnCompleteListener {
        void onComplete(IMediaPlayer mediaPlayer);
    }
    ...
    public interface OnInfoListener {
        void onInfo(IMediaPlayer mediaPlayer,int what, int extra);
    }
}